...
actuellement basé sur le noyau Linux et inclut plus de 29000 paquets de logiciels et utilitaires, soit bien
...
\def\Included{
%
En fait, la distribution Debian GNU/Linux complète consiste en plus de
7 DVDs, 44 CDs ou 2 disques Bluray.  Ces supports contiennent uniquement les
logiciels précompilés pour une architecture, sans compter les CDs des
sources. Vous y trouverez:
%
}
...
fenêtres et des deux principaux environnements de bureau: GNOME, KDE
``Plasma Desktop and Applications'' et LXDE;
%
}
