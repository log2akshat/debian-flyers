...
basée sur le noyau Linux et inclut plus de 59~000~paquets de
...
plus de 1~000) travaillent pour maintenir Debian à un haut niveau de
qualité.
%
}
...
\def\Included{
%
La distribution Debian GNU/Linux complète consiste en au moins 3~DVD.
Ces supports contiennent uniquement les logiciels précompilés pour
les architectures, les sources étant disponibles sur d'autres médias.
Vous y trouverez:
%
}
...
\def\Networking{
%
l'ensemble des protocoles réseau (PPP, IPv4, IPv6, SMB\ldots);
%
}
...
C (GCC et LLVM/Clang), Java, Python, PHP, Ruby, Perl5 et Raku
et une grande
...
outils PostScript\tm\,
et un environnement de développement complet XML/SGML/HTML;
%
}
...
\def\Databases{
%
des bases de données relationnelles comme PostgreSQL et MariaDB, des
...
\def\KnowMore{
%
Pointez votre navigateur sur \boxurl{https://www.debian.org}. Pour plus de
...
\boxurl{https://www.debian.org/MailingLists/subscribe}. De plus, il existe de
...
\boxurl{https://www.debian.org/distrib} télécharger une seul image
...
CD directement, mais fournit des images de USB, CD et DVD officielles que de
nombreux vendeurs pressent et vendent. Debian offre aussi des images pour
le nuage pour OpenStack, EC2, Azure d'autres fournisseurs de nuage informatique.
Pour les détails à propos des images officielles, allez simplement à
...
L'impression de ce prospectus a été rendue possible grâce à
vos dons.
%
}
