...
\def\MyRCS{\rcsInfo $Id: francaise.tex,v 1.11 2008/05/24 09:47:30 joostvb Exp $}
...
\def\MadeWith{
%
Prospectus créé le \today avec \LaTeX\ sur un système Debian.
%
}
...
\def\SponsorURL{http://www.mitch-it.com/}

% fichier EPS inclus dans le sous-répertoire sponsors/
%
% Mitch ict has no nice .eps logo.  If you'd like no logo to get printed, you'll have
% to hack layout.tex.  For now (and for cvs), just use the credativ logo.
