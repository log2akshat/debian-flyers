...
%
\hyphenation{a-tu-al-men-te ins-ta-lar ins-ta-la-dor}
...
de administração e permite a você executar outros programas.
...
\def\Freedom{
%
O Debian consiste completamente de Software Livre, o que
...
o desenvolvimento de pacotes até controle de qualidade, segurança, política 
...
um outro, o instalador cuida disto, e você pode fazer a nova instalação
...
\def\Stability{
%
O projeto Debian não sofre pressão comercial e não vai liberar uma versão
nova, e provavelmente instável, só porque o mercado quer. Os mantenedores do
...
\def\Included{
%
Na verdade a distribuição Debian GNU/Linux completa mal cabe em 6 CDs (com
binários pré-compilados dependentes de arquitetura, mais CDs se incluir os
...
\boxurl{http://www.debian.org/MailingLists/subscribe} para instruções.
%
}
...
instalação via rede, ou então comprar alguns CDs do Debian. O Projeto 
...
\def\SponsoredBy{
%
A impressao deste pôster foi patrocinada por
%
}
