...
\def\Portability{
%
Debian is available and runs equally well on many architectures, including Intel
x86, Intel IA-64, Alpha, Motorola 68k, PowerPC and Sun SPARC.
%
}
...
CDs (architecture-dependent precompiled binaries, even more CDs with source).
Inside you'll find:
%
}
...
clients (chat, IRC, filesharing, ~\ldots), web browsers (including the
