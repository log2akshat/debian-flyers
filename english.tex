...
\def\MyRCS{\rcsInfo $Id: english.tex,v 1.37 2011/02/04 09:34:40 gismo Exp $}
...
Free operating system.  9 architectures are supported,
including 32-bit (i386) and 64-bit (amd64) PCs, PowerPC, Sun SPARC and
ARM, plus technical previews of two new ports to the kernel of the
FreeBSD project using the known Debian/GNU userland for the 32-bit
(i386) and 64-bit (amd64) PCs.
...
\def\Included{
%
Actually, the complete Debian GNU/Linux distribution consists of at least 4
DVDs or over two dozen of CDs.  These discs hold just the architecture-dependent
