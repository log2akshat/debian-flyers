...
You can install and upgrade using DVDs, CDs, USB sticks,
...
\def\DownloadDebian{Scan QR code to download Debian 11}

\def\IncludedCaption{Included with Debian GNU/Linux}

\def\Included{
%
The complete Debian GNU/Linux distribution consists of at least 3 DVDs.
These discs hold just the architecture-dependent
...
\def\Programming{
%
development tools for major programming languages like C (via both GCC and
LLVM/Clang), Java, Python, PHP, Ruby, both Perl5 and Raku and many of the more
...
\def\Databases{
%
relational databases, like PostgreSQL and MariaDB, and
...
\boxurl{https://www.debian.org}.  For more information or help you
can join the IRC channel \#debian on \boxurl{irc.debian.org}, or
one of the Debian mailing lists. See
\boxurl{https://www.debian.org/MailingLists/subscribe} for instructions.
...
image from \boxurl{https://www.debian.org/distrib} and use it to start a network
install; order (or burn) some Debian DVDs/CDs. Debian does not sell media itself, but
provides Official USB/DVD/CD images that numerous vendors print and sell.  Debian also offers cloud images, for
OpenStack, EC2, Azure and other cloud providers.
For details about the Official images simply go to
