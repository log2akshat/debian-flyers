...
\def\Portability{
%
Debian er tillgængelig och fungerer lige godt på følgende arkitekturer:
...
netværksklienter (telnet, ftp, finger~\ldots), web-browsers, sikkerhessprogrammer
...
\def\MadeWith{
%
Dennw brochure er lavet ved hjælp af \LaTeX og ett Debian system.
%
}
